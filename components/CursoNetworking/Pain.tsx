...
import { EyeOff, TrendingDown, MessageCircleOff, DollarSign, ArrowRight } from 'lucide-react';
          ...
          <div className="grid gap-8">
            ...
            >
              ...
              <p className="text-on-surface-variant mb-6 font-medium">
                É falta de um <span className="text-primary italic font-bold">método.</span> E é exatamente isso que o curso entrega.
              </p>
