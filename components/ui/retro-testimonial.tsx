            ...
            <>
                    ...
                    {isExpanded && (
                        <div className="fixed inset-0 h-screen overflow-hidden z-50">
                            ...
                            >
                                ...
                                <p
                                    className="px-0 md:px-20 text-black/60 text-lg font-thin underline underline-offset-8"
                                >
                                    {testimonial.designation}
                                </p>
                                <p
                                    className="px-0 md:px-20 text-2xl md:text-4xl font-normal italic text-black/80 mt-4 lowercase"
                                >
                                    {testimonial.name}
                                </p>
                                <div className="py-8 text-black/80 px-0 md:px-20 text-3xl lowercase font-thin leading-snug tracking-wide">
                                    <Quote className="h-6 w-6 text-black/40 mb-4" />
                ...
                >
                    ...
                    >
                        ...
                        <p
                            className="text-black/80 text-2xl md:text-2xl font-normal text-center [text-wrap:balance] mt-4 lowercase px-3"
                        >
                        ...
                        <p
                            className="text-black/60 text-xl md:text-2xl font-thin italic text-center mt-5 lowercase"
                        >
                            {testimonial.name}.
                        </p>
                        <p
                            className="text-black/40 text-base md:text-base font-thin italic text-center mt-1 lowercase underline underline-offset-8 decoration-1"
                        >
...
const ProfileImage = ({ src, alt, ...rest }: { src: string; alt?: string;[key: string]: any }) => {
    ...
    return (
        <div className="w-[90px] h-[90px] md:w-[150px] md:h-[150px] opacity-80 overflow-hidden rounded-[1000px] border-[3px] border-solid border-[rgba(59,59,59,0.6)] aspect-[1/1] flex-none saturate-[0.2] sepia-[0.46] relative">
            <img
                className={cn(
                    "transition duration-300 absolute top-0 inset-0 rounded-inherit h-full w-full object-cover z-50",
